...
def generate_launch_description():
    ...
    flex_nav_states_test_dir = get_package_share_directory('flexbe_manipulation_states')
    ...
    return LaunchDescription([
        DeclareLaunchArgument("pkg", default_value="flexbe_manipulation_states"), #flexbe_testing"),
